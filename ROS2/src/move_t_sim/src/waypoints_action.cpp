...
public:
    ...
    void send_goal()
    {
        ...
        goal_msg.poses.push_back(get_pose_from_xy_theta(-3.1, 0.129, 1.57));
        goal_msg.poses.push_back(get_pose_from_xy_theta(-3.83, -0.868, 3.14));
        goal_msg.poses.push_back(get_pose_from_xy_theta(2.56, -2.41, -1.57));
